...
export class PracticeModeScene extends Phaser.Scene {
    ...
    create() {
        ...
        // Load saved mute state and apply to music
        const savedMute = localStorage.getItem('isMuted');
        if (savedMute && this.bgMusic) {
    ...
    private handleResize(gameSize: Phaser.Structs.Size) {
        ...
        if (this.muteButton) {
            this.muteButton.setPosition(newWidth - padding * 3, padding);
    ...
    private createMuteButton() {
        ...
        this.muteButton = this.add.container(this.cameras.main.width - padding * 3, padding);
